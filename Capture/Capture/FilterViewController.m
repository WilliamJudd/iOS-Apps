...
// Add target method the changes the camera device
...
// Extra:
// Find out how to flip camera view when changing between front and rear.
...
- (void)viewDidLoad {
 ...
 //   self.filterImageView.image = self.originalImage;
    ...
    self.filterImageView.image = [self filterImage:self.originalImage withFilterName:self.filters[9]];
